					...
					<div style="display: table-row; height: 100%;">
						<div class="adminmenubar">
							<div class="stickythingy">
								...
								<div style="text-align: center; padding: 60px; font-size: 23px;"><?php echo uilang("Developed by") ?><br>Tio, Ifan, Ilham, Farah, Ica, Wafiq</a><br><br><br><a href="" class="textlink" style="color: lime;"></a></div>
							</div>
						</div>
